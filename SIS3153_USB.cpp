...
/*
 ...
 int main(){
	...
	unsigned long myData=0x7;
	SIS3153_OPEN_DEVICE();
	int ret=SIS3153_REGISTER_READ(dev_handle,0x1,&myData);
	cout<<ret<<endl;
	myData=(myData&0xFFFF0000)>>16;
	cout<<std::hex<<myData<<endl;
	unsigned long VMEData=0xF;
	unsigned long nBytes;
	SIS3153_VME_READ(dev_handle,0x03008124,0x9,4,0,&VMEData,4, &nBytes);
	cout<<"VME REG VALUE:"<<std::hex<<(VMEData)<<endl;
	SIS3153_CLOSE_DEVICE();
	 return 0;
 }
